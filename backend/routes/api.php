...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:administrator')->prefix('admin')->group(
        function () {
    ...
    Route::middleware('role:przelozony')->prefix('przelozony')->group(
        function () {
            ...
            Route::get('/komentarze', [PrzelozonyController::class, 'getKomentarze']);
            Route::get('/kalendarz', [PrzelozonyController::class, 'getKalendarz']);
            Route::get('/statystyki', [PrzelozonyController::class, 'getStatystyki']);
        }
    );

    Route::middleware('role:pracownik')->prefix('pracownik')->group(
        function () {
